...
[`squash_track0()`](https://lj-jenkins.github.io/squashr/reference/squash_track.md)
uses R’s own `[[...]]` accessor syntax for names and errors on any
...
[`is.squashed()`](https://lj-jenkins.github.io/squashr/reference/squash_track.md)
recognises objects from both squash_track functions.
...
With
[`squash_track0()`](https://lj-jenkins.github.io/squashr/reference/squash_track.md)
the names are already valid R syntax, so conversion is straightforward.
